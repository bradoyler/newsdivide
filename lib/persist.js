...
mod.saveStreamToS3 = function saveStreamToS3(stream, key, callback) {
  ...
  s3.upload({ Body: readableStream }, function(err, data) {
    ...
    var copyParams = { Bucket: bucket, Key: primaryKeyValue, CopySource: bucket +'/'+ keyValue, ACL: 'public-read'};
